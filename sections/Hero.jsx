  ...
  return (
    <section className="relative hero-section flex justify-between container mx-auto items-center min-h-screen ">
      ...
      <div className="hero-text-content relative w-2/5">
          <p className="font-montserrat text-primary font-medium top-heading">Expore the world!</p>
      ...
      <div className="hero-images ">
        <div>
          <div className="send absolute bg-primary">
              <IoIosSend className="icon text-white" />
          </div>
