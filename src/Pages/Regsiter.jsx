          ...
          <section className='register-section font-montserrat capitalize font-medium '>
            ...
            <form className='register-modal'>
              ...
              <div className='terms-section flex items-center gap-2'>
                  ...
                  <span className='text-sm text-[#777] w-full'>by clicking on this you are aggred about</span>
              </div>
              <button onClick={handleLogin} className='submit-btn' type='submit'>sign up</button>
              <p className='notmember-text'>already have account?<Link onClick={handleSwitch} className='signin-link'>sign in</Link></p>
            </form>
        </div>
      </div>
          </section>
