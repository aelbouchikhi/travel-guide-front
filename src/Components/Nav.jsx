...
const Nav = () => {
  ...
  return (
    <header
      className={`${
        scrollPosition > 300 ? "sticky shadow-lg bg-white " : ""
      } py-4 text-[15px] transition-all duration-500  top-0 px-6 lg:px-16  z-50 `}
    >
        ...
        <div className="overflow-hidden absolute top-[0]  right-0 w-[100%] h-[100vh] md:w-[0] md:h-[0]">
          ...
          >
            ...
            <div className="flex justify-end  items-center ">
              <IoSearch
                className=" text-slate-gray mr-2 transition-all duration-500 hover:text-white hover:bg-primary p-2 hover:transition-colors   w-[40px] h-[40px] rounded-full cursor-pointer "
                size={25}
                onClick={openSearchModal}
              />
